...
{
	static readonly version					: string = "2.2";
	...
	static readonly username				: string = mw.config.get("wgUserName");
	...
	**************************************/
	static getSymbol(pID:string, pWidth:string|number=15, pHeight?:string|number) : string {
